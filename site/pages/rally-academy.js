        ...
        <section id="beginner" className="beginner-section">
          <div className="section-content">
            ...
            <div className="registration-box">
              <h3 className="registration-title">How to Register</h3>
              <div className="registration-price">
                <span className="price-amount-light">$80</span>
                <span className="price-label">Complete 4-week program</span>
              </div>
              <p className="registration-intro">To join our beginner program, please complete both steps below:</p>
              ...
              <div className="registration-steps">
                <div className="registration-step">
                  ...
                  <div className="step-content">
                    ...
                    <p>First, register with PicklePlanner for Rally Club to sign the required waiver. This is required before you can participate in any sessions.</p>
                    <a href="https://rallyclub.pickleplanner.com/" className="step-button" target="_blank" rel="noopener noreferrer">
                      Register at PicklePlanner
                    </a>
                  </div>
                </div>
                ...
                <div className="registration-step">
                  ...
                  <div className="step-content">
                    <h4>Pay for Sessions</h4>
                    <p>After signing the waiver, complete your payment for the beginner sessions.</p>
                    <a href="https://square.link/u/k6oFr2Fw" className="step-button" target="_blank" rel="noopener noreferrer">
                      Pay for Beginner Sessions
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="registration-note">
                <strong>What happens next?</strong> After you complete both steps, the instructor will add you to the PicklePlanner session. You'll receive confirmation once you're registered.
              </div>

              <p className="urgency-text">Only 8 Players Per Session!</p>
            </div>
          </div>
        </section>
        ...
        <section className="final-cta">
          <div className="cta-content">
            ...
            <div className="cta-buttons">
              <a href="#beginner" className="cta-button primary">
